...
import br.escolaprogramacao.robotmaker.Kit1Activity;
...
public class ConnectionThread extends Thread{
    ...
    public void sendMessage(String messageBoxString) {
        ...
        if(btSocket != null) {
            ...
            try {
                ...
                while(running) {
                    ...
                    toActivity(Arrays.copyOfRange(buffer, 0, bytes));
    ...
    private void toActivity(byte[] data) {
        ...
        Kit1Activity.handler_bluetooth.sendMessage(message);
    }
