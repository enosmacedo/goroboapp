...
public class LoginActivity extends AppCompatActivity {
    private ImageButton imgbtn_act_login;
...
//        });
    ...
    private void read_finger() {
        ...
        promptInfo = new BiometricPrompt.PromptInfo.Builder()
                .setTitle("Biometric login for GoRobo!")
        ...
        ImageButton biometricLoginButton = (ImageButton) findViewById(R.id.iv_login_act_login);
